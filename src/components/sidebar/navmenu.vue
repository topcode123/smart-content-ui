        ...
        >
            ...
            >
                ...
                <router-link
                    ...
                    exact
                    v-on:click.native="hidesecondmenu()"
                >
                    <feather
                        :type="menuItem.icon"
                        class="top"
    ...
    computed: {
        ...
        layoutobject: {
            get: function () {
                return JSON.parse(
                    JSON.stringify(
                        layoutClasses.find((item) => Object.keys(item).pop() === this.layout.settings.layout)
                    )
        ...
        width() {
            ...
            if (window.innerWidth < 992) {
                const newlayout = JSON.parse(
                    JSON.stringify(this.layoutobject).replace('horizontal-wrapper', 'compact-wrapper')
                );
            ...
            if (
                ...
                (window.innerWidth < 1199 && this.layout.settings.layout === 'Moscow') ||
